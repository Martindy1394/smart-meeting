...
class LiveSpeakerTests(unittest.TestCase):
    ...
    def test_participant_count_caps_voice_slots(self):
        ...
        # Extra clusters clamp onto the last registered slot.
    ...
    def test_clamp_voice_index_maps_to_registered_slots(self):
        self.assertEqual(live_speakers.clamp_voice_index(7, registered_slots=2), 2)
        self.assertEqual(live_speakers.clamp_voice_index(99, registered_slots=1), 1)
        self.assertEqual(live_speakers.clamp_voice_index(0), 1)
        self.assertEqual(live_speakers.clamp_voice_index(7), 7)
